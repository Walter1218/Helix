...
describe("matchesActor", () => {
  describe("undefined matcher", () => {
    ...
    test("excludes builtin explore / summary / title / dream / distill / compaction / main / general / build / judge", () => {
      for (const t of ["explore", "summary", "title", "dream", "distill", "compaction", "main", "general", "build", "judge"]) {
