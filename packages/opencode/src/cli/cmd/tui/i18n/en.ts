export const dict: Record<string, string> = {
  ...
  "tui.tips.mcp_oauth": "Helix auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "tui.tips.formatter": "Helix auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Helix uses LSP servers for intelligent code analysis",
  ...
  "tui.tips.plugin_protect": "Create a plugin to prevent Helix from reading sensitive files",
  ...
  "tui.tips.serve": "Run {highlight}mimo serve{/highlight} for headless API access to Helix",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Helix for curated, tested models",
