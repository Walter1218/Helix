...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "Helix 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  ...
  "tui.tips.formatter": "Helix 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "Helix 使用 LSP 伺服器進行智慧程式碼分析",
  ...
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 Helix 讀取敏感檔案",
  ...
  "tui.tips.serve": "執行 {highlight}mimo serve{/highlight} 以無介面模式提供 Helix API",
  ...
  "tui.tips.zen": "搭配 Helix 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
