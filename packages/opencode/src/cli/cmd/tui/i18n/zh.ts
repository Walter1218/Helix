...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "Helix 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  ...
  "tui.tips.formatter": "Helix 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "Helix 使用 LSP 服务器进行智能代码分析",
  ...
  "tui.tips.plugin_protect": "写一个插件阻止 Helix 读取敏感文件",
  ...
  "tui.tips.serve": "运行 {highlight}mimo serve{/highlight} 以无头模式提供 Helix API",
  ...
  "tui.tips.zen": "搭配 Helix 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
