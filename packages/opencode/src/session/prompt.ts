      ...
      function* (sessionID: SessionID, agentID?: string, task_id?: string) {
        ...
        while (true) {
          ...
          if (step === 1 && !session.parentID) {
            ...
            // These spawn background sessions that consolidate memory and workflows.
            // We use AppRuntime directly to dispatch them without blocking the main flow.
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            if (isForkAgent) {
              ...
              if (result === "stop" || result === "suspend") return "break" as const
